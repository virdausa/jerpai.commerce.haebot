...
function PartnerLogo() {
  return (
    <div className="mx-auto flex max-w-7xl items-center justify-around px-6 py-4 md:px-10 md:py-8">
      <Image className="h-10 w-fit" src={mazak} alt="Yamazaki Mazak" />
      <Image className="h-10 w-fit" src={haas} alt="Haas Automation" />
      <Image className="h-10 w-fit" src={hardinge} alt="Hardinge" />
    </div>
  );
}
